  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      <p className="text-start text-xl text-gray-700 leading-relaxed mb-4">
        ...
        माध्यम से आप विद्यार्थियों की गतिविधियाँ, सांस्कृतिक कार्यक्रम, अनुशासन
        और सीखने के वातावरण को करीब से अनुभव कर सकते हैं। हर चित्र एक कहानी कहता
        है — परिश्रम, समर्पण और संस्कारों की कहानी। यह दीर्घा न केवल हमारे
        गुरुकुलम के दैनिक जीवन को दर्शाती है, बल्कि यहाँ के सकारात्मक और
        प्रेरणादायक माहौल को भी जीवंत रूप में प्रस्तुत करती है।
      </p>
